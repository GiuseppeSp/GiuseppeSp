...
| **[Awesome LangWatch Agents](https://github.com/GiuseppeSp/awesome-langwatch-agents)** | Curated catalog of runnable AI agents — every one ships with LangWatch traces, a hand-labeled golden dataset, and pass/fail evaluators. Patterns covered: simple RAG, multi-turn chatbot with memory, tool-use, agentic routing, multi-agent pipelines. The extracted, reusable version of the lessons learned building Nonna's Cookbook | Python, OpenAI, LangWatch |
