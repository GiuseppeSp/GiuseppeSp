...
| **Awesome LangWatch Agents** | Curated catalog of 5 runnable AI agents — each ships with LangWatch traces, a hand-labeled golden dataset, pass/fail evaluators, and a measured tuning experiment. Patterns: simple RAG, multi-turn chatbot memory, tool-use, agentic routing, multi-agent pipelines. | Python, OpenAI, LangWatch |
